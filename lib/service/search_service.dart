...
class SearchService{
  static Future<List<SearchModel>> search({http.Client? client, String context = "view", String? page = "1", String? perPage = "3", String? search = ""}) async{
    ...
    var uri =
    Uri.https(baseUrlFormatted, endpoint, queryParams);
